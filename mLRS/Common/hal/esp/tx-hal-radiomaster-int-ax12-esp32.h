...
/*
  ...
  - Power up radio, plug in USB (DSC)
  - In Radiomaster App on radio, goto Settings > ELRS > Update ELRS
...
#define DEVICE_SENDS_CRSF_SYNC_PACKET
...
#define UARTB_USE_SERIAL2 // serial
